...
export const handlers: Record<string, (payload: any) => unknown> = {
  ...
  'ledgers.openings': ledgers.listOpeningBalances,
  'ledgers.setOpening': ledgers.setOpeningBalance,
  'ledgers.setOpenings': ledgers.setOpeningBalances,
  ...
  'machinery.lastMeter': machinery.lastMachineMeter,
  ...
  'parts.list': parts.listParts,
  'parts.create': parts.createPart,
  ...
  'diesel.issuesAll': diesel.listDieselIssuesAll,
